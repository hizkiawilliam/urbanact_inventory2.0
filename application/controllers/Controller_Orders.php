	...
	*/
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {        	
        	...
        	$marketplace = $this->model_marketplace->getMarketplaceData(1);
        	$this->data['marketplace_data'] = $marketplace;
        	$this->data['products'] = $this->model_products->getActiveProductData();
			$this->data['marketplace'] = $this->model_marketplace->getActiveMarketplace();
	...
	*/
	public function update($id)
	{
        ...
        if ($this->form_validation->run() == TRUE) {        	
            ...
            // false case
			$marketplace = $this->model_marketplace->getMarketplaceData();
        	$this->data['marketplace_data'] = $marketplace;
        	...
        	$this->data['products'] = $this->model_products->getActiveProductData();      	
			$this->data['marketplace'] = $this->model_marketplace->getActiveMarketplace();      	
			$this->data['nama_marketplace'] = $this->model_orders->getNamaMarketplace($orders_data['id']);      	
	...
	*/
	public function printDiv($id)
	{
		...
		if($id) {
			...
			$marketplace_id = $order_data['marketplace'];
			$marketplace_info = $this->model_marketplace->getMarketplaceData($marketplace_id);
			  ...
			  <section class="invoice">
			    ...
			    <div class="row">
			      <div class="col-xs-12">
			        <h2 class="page-header">
			          Urban Act
			          <small class="pull-right">Date: '.$order_data['date'].'</small>
			        </h2>
			      </div>
			      <!-- /.col -->
			    </div>
			    ...
			    <div class="row invoice-info">
			      ...
			      <div class="col-sm-4 invoice-col">
					...
					<b>Marketplace:</b> '.$marketplace_info['marketplace_name'].'
			      </div>
			      <!-- /.col -->
			    </div>
			    <!-- /.row -->
