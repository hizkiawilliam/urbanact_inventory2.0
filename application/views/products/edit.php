          ...
          <form role="form" action="<?php base_url('users/update') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="hpp" name="hpp" placeholder="Enter HPP" value="<?php echo $product_data['hpp']; ?>" autocomplete="off" />
                </div>
                ...
                <?php $attribute_id = ($product_data['attribute_value_id']); ?>
                ...
                <div class="form-group">
                  ...
                  <?php $items_data = $product_data['items_id']; ?>
