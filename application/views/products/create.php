  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">        
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('Controller_Products/create') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="hpp" name="hpp" placeholder="Enter HPP" autocomplete="off" />
                </div>
                  ...
                  <?php foreach ($attributes as $k => $v): ?>
                    <div class="form-group">
                      ...
                      <select class="form-control select_group" id="attributes_value_id" name="attributes_value_id[]">
                        <option value="">= Select <?php echo $v['attribute_data']['name'] ?> = </option>
                ...
                <div class="form-group">
                  <label for="items">Material</label>
                  <select class="form-control select_group" id="items" name="items">
