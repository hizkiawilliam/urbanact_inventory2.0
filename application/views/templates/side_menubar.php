    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li id="dashboardMainMenu">
          ...
          <?php if(in_array('createItems', $user_permission) || in_array('updateItems', $user_permission) || in_array('viewItems', $user_permission) || in_array('deleteItems', $user_permission)): ?>
            <li id="itemsNav">
              <a href="<?php echo base_url('Controller_Items/') ?>">
                <i class="fa fa-cart-arrow-down"></i> <span>Materials</span>
              </a>
            </li>
          <?php endif; ?>
          ...
          <?php if(in_array('createMarketplace', $user_permission) || in_array('updateMarketplace', $user_permission) || in_array('viewMarketplace', $user_permission) || in_array('deleteMarketplace', $user_permission)): ?>
            <li class="treeview" id="marketplaceNav">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <?php if(in_array('createMarketplace', $user_permission)): ?>
                  <li id="addMarketplaceNav"><a href="<?php echo base_url('Controller_Marketplace/create') ?>"><i class="fa fa-circle-o"></i> Add Marketplace</a></li>
                <?php endif; ?>
                <?php if(in_array('updateMarketplace', $user_permission) || in_array('viewMarketplace', $user_permission) || in_array('deleteMarketplace', $user_permission)): ?>
                <li id="manageMarketplaceNav"><a href="<?php echo base_url('Controller_Marketplace') ?>"><i class="fa fa-circle-o"></i> Manage Marketplace</a></li>
                <?php endif; ?>
              </ul>
            </li>
          <?php endif; ?>
