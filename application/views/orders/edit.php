          ...
          <form role="form" action="<?php base_url('Controller_Orders/update') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-7 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Marketplace</label>
                    <div class="col-sm-7">
                      <select class="form-control select_group marketplace" id="marketplace_id" name="marketplace_id" style="width:100%;" onchange="getMarketplaceData()" required>
                      <option value="<?php echo $nama_marketplace['id']; ?>"><?php echo $nama_marketplace['marketplace_name']; ?></option>
                          <?php foreach ($marketplace as $k => $v): ?>
                            <?php if ($v['marketplace_name']!=$nama_marketplace['marketplace_name']): ?>
                              <option value="<?php echo $v['id'] ?>"><?php echo $v['marketplace_name'] ?></option>
                            <?php endif; ?>    
                            <?php endforeach; ?>
                     </select>
                    </div>
