                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Marketplace</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createMarketplace" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateMarketplace" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewMarketplace" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteMarketplace" class="minimal"></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
