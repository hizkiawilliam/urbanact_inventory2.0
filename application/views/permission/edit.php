                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Items</td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="createItems" <?php if($serialize_permission) {
                          if(in_array('createItems', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateItems" <?php if($serialize_permission) {
                          if(in_array('updateItems', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewItems" <?php if($serialize_permission) {
                          if(in_array('viewItems', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteItems" <?php if($serialize_permission) {
                          if(in_array('deleteItems', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
                      <tr>
                        <td>Category</td>
                      ...
                      <tr>
                        <td>Marketplace</td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="createMarketplace" <?php if($serialize_permission) {
                          if(in_array('createMarketplace', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateMarketplace" <?php if($serialize_permission) {
                          if(in_array('updateMarketplace', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewMarketplace" <?php if($serialize_permission) {
                          if(in_array('viewMarketplace', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteMarketplace" <?php if($serialize_permission) {
                          if(in_array('deleteMarketplace', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
                    </tbody>
                  </table>
